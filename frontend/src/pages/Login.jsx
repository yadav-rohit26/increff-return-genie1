...
const Login = () => {
  ...
  return (
    <div className={`page-wrapper increff-bg d-flex align-items-center justify-content-center vh-100 px-3 ${exiting ? 'animate-page-exit' : ''}`}>
      <div className="increff-card bg-white p-4 p-md-5 shadow-sm border-0 rounded-1 stagger-1" style={{ maxWidth: '420px', width: '100%', minHeight: '380px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        
        {loading ? (
          <div className="text-center animate-fade-in">
            <div className="spinner-border mb-3" style={{ width: '3rem', height: '3rem', color: 'var(--primary)' }} role="status">
              <span className="visually-hidden">Loading...</span>
            </div>
            <h4 className="inc-text-lg fw-bold text-gray-800 tracking-tight">Preparing Workspace</h4>
            <p className="text-secondary inc-text-sm mt-2">Authenticating and securing your connection...</p>
          </div>
        ) : (
          <>
            <div className="text-center mb-4 stagger-2">
              <img 
