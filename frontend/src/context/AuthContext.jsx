...
export const AuthProvider = ({ children }) => {
  ...
  const updateClient = async (clientId, clientData) => {
    try {
      const res = await axios.put(`${API_URL}/api/auth/client/${clientId}`, clientData);
      if (res.data.success) {
        await fetchClients();
        return { success: true };
      }
  ...
  return (
    <AuthContext.Provider value={{
      currentUser, activeClient, clients, fetchClients, addClient, updateClient, deleteClient,
