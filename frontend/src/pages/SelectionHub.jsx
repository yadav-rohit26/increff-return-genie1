...
const SelectionHub = () => {
  ...
  return (
    <div className="page-wrapper">
      <nav aria-label="breadcrumb" className="mb-4 pt-3 stagger-1">
      ...
      <div className="row justify-content-center">
        <div className="col-12 col-xl-10">
          <div className="increff-card bg-white p-4 p-md-5 shadow-sm border-0 rounded-1 stagger-2" style={{ borderLeft: `5px solid ${primaryColor}` }}>
            <div className="text-center mb-5 stagger-3">
            ...
            <div className="row g-4 justify-content-center stagger-4">
              {/* Box 1: Omni */}
